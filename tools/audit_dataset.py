"""Audit a manifest and emit dataset-quality CSV/Markdown reports."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", type=Path, required=True, help="Audit CSV output path")
...
def main() -> None:
    ...
    if args.summary:
        write_summary_markdown(rows, args.summary, args.manifest, thresholds)
